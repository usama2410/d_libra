...
{
  theme ? <div style={{display: "flex", alignItems: "center"}}><img src={Vector3Blue} alt="" /><img  src={TagBlue} alt="" /></div> : <div style={{display: "flex", alignItems: "center"}}><img src={Vector3} alt="" /><img style={{paddingLeft: "5px"}}  src={Tag} alt="" /></div> 
}
