...
const LandingPageMainDataOne = [
  ...
  {
    chapterName: "Courses with Bookmark Contents",
    items: [
      {
        id: 1,
        image: GitGitHubIntroduction,
...
const LandingPageMainDataTwo = [
  {
    chapterName: "Category A",
    items: [
      {
        id: 1,
        image: GitGitHubIntroduction,
...
export default { LandingPageMainDataOne, LandingPageMainDataTwo };
